...
THEME_OVERRIDES = {
    ...
    "128138.SZ": ["环保-固废水处理"],
    "113579.SH": ["原料药"],  # 健友股份: 肝素原料药+制剂
    "123267.SZ": ["半导体-零部件"],  # 珂玛科技: 先进陶瓷零部件 (静电卡盘/陶瓷加热器), 关键词"陶瓷部件"无法命中"陶瓷零部件"
    "123269.SZ": ["电池结构件-铜箔铝箔", "动力电池"],  # 金杨精密: 电池精密结构件, 关键词"测试"误配后道封测
    "127033.SZ": ["建筑装饰-设计施工"],  # 中装建设: 建筑装饰为主, 物管为辅
}
